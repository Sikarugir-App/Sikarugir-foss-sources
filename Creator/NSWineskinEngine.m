...
#define DEFAULT_WINESKIN_ENGINE_VERSION    12

static NSString *const REGEX_VALID_WINESKIN_ENGINE =                 @"[A-Z]{2}[0-9]+Wine(CX|CXG|Sikarugir|Proton|Staging)?(Gnutls|Vulkan)?(64Bit)?[0-9\\.]+[^\\n]*";
...
{
    NSString* supportedExtension = @".tar.xz";
